import{j as r,t as n}from"./app-DGV30_58.js";function g({links:a,className:s=""}){return a.length<=3?null:r.jsx("nav",{className:s,children:r.jsx("ul",{className:"inline-flex items-center -space-x-px",children:a.map((e,t)=>{const l=`
