                ...
                <div className="max-w-screen-xl mx-auto px-4 grid md:grid-cols-5 gap-12 items-center">
                    ...
                    <div className="md:col-span-3 text-left">
                        <h1 className="text-4xl md:text-5xl font-extrabold text-primary mb-4">
                            Mengenal {settings.organization_name}
                        </h1>
                        <div className="space-y-4 text-gray-700 leading-relaxed">
                            <p>{settings.definition}</p>
                        </div>
                    </div>
                ...
                <div className="max-w-screen-xl mx-auto px-4">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-gray-600 mt-2">
                            Landasan Gerak dan Arah {settings.organization_name}{" "}
                            Kabinet {settings.cabinet_name}
                        </p>
                    </div>
                ...
                <div className="max-w-screen-xl mx-auto px-4">
                    ...
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        ...
                        <div className="flex justify-center items-center p-8">
                            <img
                                src={`storage/${settings.logo_vertical_path}`}
